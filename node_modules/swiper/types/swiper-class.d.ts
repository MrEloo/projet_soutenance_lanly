...
import type { CSSSelector, SwiperModule } from 'swiper/types/shared';
import type { SwiperEvents } from 'swiper/types/swiper-events';

import type { A11yMethods } from 'swiper/types/modules/a11y';
import type { AutoplayMethods } from 'swiper/types/modules/autoplay';
import type { ControllerMethods } from 'swiper/types/modules/controller';
import type { CoverflowEffectMethods } from 'swiper/types/modules/effect-coverflow';
import type { CubeEffectMethods } from 'swiper/types/modules/effect-cube';
import type { FadeEffectMethods } from 'swiper/types/modules/effect-fade';
import type { FlipEffectMethods } from 'swiper/types/modules/effect-flip';
import type { CreativeEffectMethods } from 'swiper/types/modules/effect-creative';
import type { CardsEffectMethods } from 'swiper/types/modules/effect-cards';
import type { HashNavigationMethods } from 'swiper/types/modules/hash-navigation';
import type { HistoryMethods } from 'swiper/types/modules/history';
import type { KeyboardMethods } from 'swiper/types/modules/keyboard';
import type { MousewheelMethods } from 'swiper/types/modules/mousewheel';
import type { NavigationMethods } from 'swiper/types/modules/navigation';
import type { PaginationMethods } from 'swiper/types/modules/pagination';
import type { ParallaxMethods } from 'swiper/types/modules/parallax';
import type { ScrollbarMethods } from 'swiper/types/modules/scrollbar';
import type { ThumbsMethods } from 'swiper/types/modules/thumbs';
import type { VirtualMethods } from 'swiper/types/modules/virtual';
import type { ZoomMethods } from 'swiper/types/modules/zoom';
import type { FreeModeMethods } from 'swiper/types/modules/free-mode';
import type { ManipulationMethods } from 'swiper/types/modules/manipulation';
