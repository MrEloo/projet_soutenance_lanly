...
import type { A11yEvents } from 'swiper/types/modules/a11y';
import type { AutoplayEvents } from 'swiper/types/modules/autoplay';
import type { ControllerEvents } from 'swiper/types/modules/controller';
import type { CoverflowEffectEvents } from 'swiper/types/modules/effect-coverflow';
import type { CubeEffectEvents } from 'swiper/types/modules/effect-cube';
import type { FadeEffectEvents } from 'swiper/types/modules/effect-fade';
import type { FlipEffectEvents } from 'swiper/types/modules/effect-flip';
import type { CreativeEffectEvents } from 'swiper/types/modules/effect-creative';
import type { CardsEffectEvents } from 'swiper/types/modules/effect-cards';
import type { HashNavigationEvents } from 'swiper/types/modules/hash-navigation';
import type { HistoryEvents } from 'swiper/types/modules/history';
import type { KeyboardEvents } from 'swiper/types/modules/keyboard';
import type { MousewheelEvents } from 'swiper/types/modules/mousewheel';
import type { NavigationEvents } from 'swiper/types/modules/navigation';
import type { PaginationEvents } from 'swiper/types/modules/pagination';
import type { ParallaxEvents } from 'swiper/types/modules/parallax';
import type { ScrollbarEvents } from 'swiper/types/modules/scrollbar';
import type { ThumbsEvents } from 'swiper/types/modules/thumbs';
import type { VirtualEvents } from 'swiper/types/modules/virtual';
import type { ZoomEvents } from 'swiper/types/modules/zoom';
import type { FreeModeEvents } from 'swiper/types/modules/free-mode';
